...
export class Kafic
{
    ...
    crtajFormu(host)
    {
        ...
        labela.innerHTML="Dobrošli u kafić "+ this.Naziv+"!";
    ...
    crtajFormuIzaberiSto(host)
    {
       ...
       poljeLabela.forEach((el,i)=>{
        ...
        dugme.onclick=(ev)=>{
           ...
           fetch("https://localhost:5001/Kafic/ZauzmiSto"+this.id,{
        ...
        dugme2.onclick=(ev)=>
        {
           ...
           else if( this.stolovi[this.x*red+parseInt(kolona)].kapacitet<=0)
           {
             ...
             fetch("https://localhost:5001/Kafic/OslobodiSto/"+red+"/"+kolona+"/"+this.id,{
                        method: "DELETE"
                    }).then(resp=>{
                        if(resp.ok){
                            location.reload();
        ...
        dugme3.onclick=(ev)=>
        {
            ...
            if(brLjudi>this.kapacitetStola)
            {
                ...
                alert("Zao mi je, ne mozete promeniti broj ljudi za ovim stolom jer ovaj broj je van dozvoljenog opsega.");
            }
            else
            {

               fetch("https://localhost:5001/Kafic/IzmeniSto/"+red+"/"+kolona+"/"+brLjudi+"/"+this.id,{
                        method: "PUT"
                    }).then(resp=>{
                        if(resp.ok){
                            location.reload();
    ...
    crtajFormuPoruci(host)
    {
        ...
        dugme.onclick=(ev)=>{
           ...
           let sto=redniBroj.value;
            ...
            fetch("https://localhost:5001/Kafic/DodajPorudzbinu"+this.id,{
        ...
        dugme.onclick=(ev)=>
        {
           ...
           {
            fetch("https://localhost:5001/Kafic/OtkaziPorudzbinu/"+red+"/"+kolona,{
                method: "DELETE"
            }).then(resp=>{
                if(resp.ok){
                    location.reload();
